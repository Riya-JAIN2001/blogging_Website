...
//             `https://api.cloudinary.com/v1_1/bloggingwebsite/image/upload`,
//             {
//               method: "post",
//               body: data,
//             }
...
//           setImageUrl(fres.url)
         
//     }
//   return (
//     <div className='bg-[url("yellowbg.webp")] h-screen w-screen border-none  bg-contain bg-center bg-fixed'>
//         <Appbar pr={true}  />
//     <div className ="flex justify-center w-full">
//     <div className="max-w-screen-lg w-full mt-10">   
// <textarea id="message"  className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Title" defaultValue= {blog.title}  onChange={(e)=>setTitle(e.target.value)}></textarea>


// <div className="mt-10"><TextEditor  onChange={(e)=>setContent(e.target.value)}/>
//     <input type="file" accept="image/*"  className="border-none bg-gray-200 rounded-md" onChange={(e)=>{
    
//     //@ts-ignore
//     setImage(e.target.files[0])}}/>
//     <button className= "inline-flex items-center px-5 py-2.5 mx-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800"onClick={handleClick}>add photo</button>
// <button 
...
//    type="submit" className="inline-flex items-center px-5 py-2.5 mx-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
//        Edit post
//    </button>
//    <div>
//     {<img  className="w-96 h-96" src={blog.Image} alt ="sorrt"/>}
//    </div>
...
//            <textarea id="editor"  onChange={onChange} rows={8}  className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." defaultValue={blog.content}  required ></textarea>
//        </div>
//    </div>
                    ...
                    {loading ? (
                        ...
                        <div>
                            ...
                            <div className="flex space-x-4">
                                <button
                                    className="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-200"
