...
//     }
//   return (
//     <div className='bg-[url("yellowbg.webp")] w-screen h-screen border-none  bg-contain bg-center bg-fixed'>
//         <Appbar pr={true}  />
//     <div className =" bg-[url('yellowbg.webp')]  border-none  bg-contain bg-center bg-fixed flex justify-center w-full">
...
//            <textarea id="editor" onChange={onChange} rows={8}  className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required ></textarea>
//        </div>
//    </div>
      ...
      <div className="flex flex-col items-center justify-center mt-10 p-4">
        <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl w-full">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between mt-4">
            ...
            />
            <button
              className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-200"
          ...
          <button
            className="mt-6 inline-flex items-center px-5 py-2.5 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-200"
